...
Zooms into the system boundary to show the high-level shape of the software architecture. A _container_ in C4 is any separately runnable/deployable unit — a web app, mobile app, desktop app, database, file system, serverless function, message queue, etc.
